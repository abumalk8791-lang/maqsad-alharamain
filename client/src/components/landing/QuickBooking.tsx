...
export default function QuickBooking() {
  ...
  const submit = () => {
    const msg = [
      ...
      "أود الاستفسار عن برنامج متاح لدى مقصد الحرمين، وهذه تفاصيل طلبي:",
      `• نوع الرحلة: ${type}`,
      `• الوجهة: من الرياض إلى ${to}`,
      date ? `• الموعد المفضل: ${formatDate(date)}` : "• الموعد المفضل: لم يُحدَّد بعد",
      "أرجو تزويدي بالمدة المتاحة، وخيارات الإقامة والنقل، والسعر الحالي، وطريقة الحجز.",
      "وشكراً لكم."
    ].join("\n");
