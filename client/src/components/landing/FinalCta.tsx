...
export default function FinalCta() {
  return (
    <section id="contact" className="relative py-28 md:py-40 overflow-hidden">
      <img
        src={ASSETS.finalCta}
        alt="الكعبة المشرفة ليلًا والحجاج في الطواف"
        loading="lazy"
      ...
      <div className="relative z-10 container text-center">
        <div className="reveal">
          <span className="kicker justify-center !text-[var(--gold-soft)]">جاهز لرحلتك إلى الحرمين؟</span>
          <h2 className="mt-5 text-3xl md:text-6xl font-bold text-white [text-shadow:0_2px_20px_rgba(0,0,0,0.5)]">
            مقصد الحرمين... بداية رحلة لا تُنسى
          </h2>
          <p className="mt-5 text-lg md:text-2xl text-white/80 font-light">خطوتك الأولى تبدأ برسالة.</p>
